...
<div class="container-fluid">
    <h2 class="h3 mb-0 text-gray-800">Óleos Cadastrados</h2>
    ...
    <?php if ($oleos ) : ?>
        <?php foreach ($oleos as $oleo) : ?>
            <tr>
                <td><?php echo $oleo['nome']; ?></td>
                <?php translateFaboleo($oleo['fabricante']); ?>
                <td><?php echo $nameFaboleo;?></td>
                <td class="actions text-right">
                    <a href="view.php?snum=<?php echo $oleo['id_oleo']; ?>" class="btn btn-sm btn-primary text-right">Visualizar</a>
                    <a href="edit.php?snum=<?php echo $oleo['id_oleo']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-oleo" data-maquina="<?php echo $oleo['id_oleo']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
