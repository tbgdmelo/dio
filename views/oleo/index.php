        ...
        <?php foreach ($oleos as $oleo) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="edit.php?id_oleo=<?php echo $oleo['id_oleo']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-oleo" data-oleo="<?php echo $oleo['id_oleo']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
