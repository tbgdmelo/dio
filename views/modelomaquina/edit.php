...
<head>
    ...
    <title>Atualizar Cadastro Modelo Máquina</title>
</head>
...
<div id="content">
  ...
  <h2 class="h3 mb-0 text-gray-800">Atualizar Dados do Modelo</h2>
<form action="edit.php?id_modelo=<?php echo $modelomaquina['id_modelo']; ?>" method="post" enctype="multipart/form-data">
  <!-- area de campos do form -->
  <hr />
  <div class="row">
    <div class="form-group col-md-3">
      <label for="name">Nome:</label>
      <input type="text" class="form-control" name="modelomaquina['nome']" value="<?php echo $modelomaquina['nome']; ?>">
    </div>
  </div>
