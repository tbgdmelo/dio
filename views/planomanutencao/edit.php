...
<head>
    ...
    <title>Atualizar Plano de Manutenção</title>
</head>
...
<div id="content">
  ...
  <h2 class="h3 mb-0 text-gray-800">Atualizar Dados do Plano</h2>
<form action="edit.php?id_plano=<?php echo $planomanutencao['id_plano']; ?>" method="post" enctype="multipart/form-data">
  <!-- area de campos do form -->
  <hr />
  <div class="row">
    <div class="form-group col-md-3">
        <label for="name">Custo:</label>
        <input type="text" class="form-control" value="<?php echo $planomanutencao['custo']; ?>" id="currency" name="planomanutencao['custo']" size="15" maxlength="11" data-decimal="."/>
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        <label for="campo2">Maquina:</label>
            <select class="form-control" name="planomanutencao['serial_maquina']">
                <option onfocus="true">Selecione...</option>
                <?php if ($maquinas) : ?>
                    <?php foreach ($maquinas as $maquina) : ?>
                        <option value="<?php echo $maquina['snum']; ?>"><?php echo $maquina['nome']; ?></option>
                    <?php endforeach; ?>
                <?php else : ?>
                    <option>Nenhum registro encontrado.</option>
                <?php endif; ?>
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            <textarea type="text" class="form-control" rows="7" name="planomanutencao['motivo']"><?php echo $planomanutencao['motivo']; ?></textarea>
        </div>
    </div>
  <div id="actions" class="row">
      <div class="col-md-12">
        <button type="submit" class="btn btn-success">Salvar</button>
        <a href="../home.html" class="btn btn-danger">Cancelar</a>
      </div>
    </div>
  </form>
