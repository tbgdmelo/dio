...
<head>
    ...
    <title>Cadastro Tipo Lubrificação</title>
</head>
...
<div class="container-fluid">
  <h2 class="h3 mb-0 text-gray-800">Novo Tipo Lubrificação</h2>
<form action="add.php" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="tipolubrificacao['nome']" autofocus="" placeholder="Nome">
    </div>
  </div>
