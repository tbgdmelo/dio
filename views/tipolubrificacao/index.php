        ...
        <?php foreach ($tipolubrificacoes as $tipolubrificacao) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="edit.php?id_lubrificacao=<?php echo $tipolubrificacao['id_lubrificacao']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-lub" data-lub="<?php echo $tipolubrificacao['id_lubrificacao']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
...
<script src="<?php echo BASEURL; ?>front/js/modal_lubrificacao.js"></script>