...
<head>
    ...
    <title>Tipos de Lubrificação</title>
</head>
...
<div class="container-fluid">
    <h2 class="h3 mb-0 text-gray-800">Tipos de Lubrificação Cadastrados</h2>
    ...
    <tbody>
    <?php if ($tipolubrificacoes ) : ?>
        <?php foreach ($tipolubrificacoes as $tipolubrificacao) : ?>
            <tr>
                <td><?php echo $tipolubrificacao['nome']; ?></td>
                <td class="actions text-right">
                    <a href="view.php?snum=<?php echo $tipolubrificacao['id_lubrificacao']; ?>" class="btn btn-sm btn-primary text-right">Visualizar</a>
                    <a href="edit.php?snum=<?php echo $tipolubrificacao['id_lubrificacao']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-lub" data-maquina="<?php echo $tipolubrificacao['id_lubrificacao']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
