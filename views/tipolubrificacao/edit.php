...
<head>
    ...
    <title>Atualizar Cadastro Lubrificação</title>
</head>
...
<div id="content">
  ...
  <h2 class="h3 mb-0 text-gray-800">Atualizar Dados</h2>
<form action="edit.php?id_lubrificacao=<?php echo $tipolubrificacao['id_lubrificacao']; ?>" method="post" enctype="multipart/form-data">
  <!-- area de campos do form -->
  <hr />
  <div class="row">
    <div class="form-group col-md-3">
      <label for="name">Nome:</label>
      <input type="text" class="form-control" name="tipolubrificacao['nome']" value="<?php echo $tipolubrificacao['nome']; ?>">
    </div>
  </div>
