...
<head>
    ...
    <title>Cadastro Fabricante Óleo</title>
</head>
...
<div class="container-fluid">
  <h2 class="h3 mb-0 text-gray-800">Novo Fabricante de Óleo</h2>
<form action="add.php" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="fabricanteoleo['nome']" autofocus="" placeholder="Nome">
    </div>
  </div>
