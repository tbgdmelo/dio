        ...
        <?php foreach ($fabricantesoleo as $fabricanteoleo) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="edit.php?id_faboleo=<?php echo $fabricanteoleo['id_faboleo']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-faboleo" data-faboleo="<?php echo $fabricanteoleo['id_faboleo']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
