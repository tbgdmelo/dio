...
<head>
    ...
    <title>Fabricantes de Óleo</title>
</head>
...
<div class="container-fluid">
    ...
    <tbody>
    <?php if ($fabricantesoleo ) : ?>
        <?php foreach ($fabricantesoleo as $fabricanteoleo) : ?>
            <tr>
                <td><?php echo $fabricanteoleo['nome']; ?></td>
                <td class="actions text-right">
                    <a href="view.php?snum=<?php echo $fabricanteoleo['id_faboleo']; ?>" class="btn btn-sm btn-primary text-right">Visualizar</a>
                    <a href="edit.php?snum=<?php echo $fabricanteoleo['id_faboleo']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-faboleo" data-maquina="<?php echo $fabricanteoleo['id_faboleo']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
