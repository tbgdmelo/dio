        ...
        <?php foreach ($fabricantesfiltro as $fabricantefiltro) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="view.php?snum=<?php echo $fabricantefiltro['id_fabfiltro']; ?>" class="btn btn-sm btn-primary text-right">Visualizar</a>
                    <a href="edit.php?snum=<?php echo $fabricantefiltro['id_fabfiltro']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-fabfiltro" data-maquina="<?php echo $fabricantefiltro['id_fabfiltro']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
