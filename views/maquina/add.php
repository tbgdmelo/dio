...
<div class="container-fluid">
  <h2 class="h3 mb-0 text-gray-800">Nova Máquina</h2>
  ...
  <form action="add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" name="maquina['snum']" autofocus="" placeholder="Nº Serial" maxlength="50">
        </div>
        <div class="form-group col-md-3">
            <label for="name">Nome:</label>
            <input type="text" class="form-control" name="maquina['nome']" placeholder="Nome" maxlength="100">
        </div>
        <div class="form-group col-md-3">
            <label for="name">Tempo de Trabalho (Horas):</label>
            <input type="number" class="form-control" name="maquina['tempotrabalho']"/>
        </div>
        <div class="form-group col-md-3">
            <label for="name">Tempo Filtro (Dias):</label>
            <input type="number" class="form-control" name="maquina['tempofiltro']"/>
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-3">
            <label for="name">Tempo Oleo (Dias):</label>
            <input type="number" class="form-control" name="maquina['tempooleo']"/>
        </div>
        <div class="form-group col-md-3">
