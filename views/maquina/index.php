...
<head>
    ...
    <title>Máquinas Cadastradas</title>
</head>
...
<div class="container-fluid">
    <h2 class="h3 mb-0 text-gray-800">Máquinas Cadastradas</h2>
    ...
    <?php if ($maquinas ) : ?>
        <?php foreach ($maquinas as $maquina) : ?>
            <tr>
                <td><?php echo $maquina['snum']; ?></td>
                <td><?php echo $maquina['nome']; ?></td>
                <td><?php echo $maquina['tempotrabalho']. " Horas"; ?></td>
                <td><?php echo $maquina['tempofiltro']. " Dias"; ?></td>
                <td><?php echo $maquina['tempooleo']. " Dias"; ?></td>
                <?php translate($maquina['modelo'], $maquina['lubrificacao'], $maquina['oleo'], $maquina['filtro']); ?>
                <td><?php echo $nameMod; ?></td>
                <td><?php echo $nameLub; ?></td>
                <td><?php echo $nameOleo; ?></td>
                <td><?php echo $nameFiltro; ?></td>
                <td>
                    <a href="view.php?snum=<?php echo $maquina['snum']; ?>" class="btn btn-sm btn-primary">Visualizar</a>
                </td>
                <td>
                    <a href="edit.php?snum=<?php echo $maquina['snum']; ?>" class="btn btn-sm btn-warning">Editar</a>
                </td>
                <td>
                  <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-maq" data-maquina="<?php echo $maquina['snum']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
...
<script src="<?php echo BASEURL; ?>front/js/modal_maquina.js"></script>