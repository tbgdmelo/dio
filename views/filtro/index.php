        ...
        <?php foreach ($filtros as $filtro) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="edit.php?id_filtro=<?php echo $filtro['id_filtro']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-filtro" data-filtro="<?php echo $filtro['id_filtro']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
...
<script src="<?php echo BASEURL; ?>front/js/modal_filtro.js"></script>