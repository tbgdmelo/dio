...
<head>
    ...
    <title>Filtros Cadastrados</title>
</head>
...
<div class="container-fluid">
    <h2 class="h3 mb-0 text-gray-800">Tipos de Filtros Cadastrados</h2>
    ...
    <?php if ($filtros) : ?>
        <?php foreach ($filtros as $filtro) : ?>
            <tr>
                <td><?php echo $filtro['nome']; ?></td>
                <?php translateFabricantesF($filtro['fabricante']); ?>
                <td><?php echo $nameFab; ?></td>
                <td class="actions text-right">
                    <a href="view.php?snum=<?php echo $filtro['id_filtro']; ?>" class="btn btn-sm btn-primary text-right">Visualizar</a>
                    <a href="edit.php?snum=<?php echo $filtro['id_filtro']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-filtro" data-maquina="<?php echo $filtro['id_filtro']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
