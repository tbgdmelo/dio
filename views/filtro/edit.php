...
<head>
    ...
    <title>Atualizar Cadastro Filtro</title>
</head>
...
<div id="content">
  ...
  <h2 class="h3 mb-0 text-gray-800">Atualizar Dados do Filtro</h2>
<form action="edit.php?id_filtro=<?php echo $filtro['id_filtro']; ?>" method="post" enctype="multipart/form-data">
  <!-- area de campos do form -->
  <hr />
  <div class="row">
    <div class="form-group col-md-3">
      <label for="name">Nome:</label>
      <input type="text" class="form-control" name="filtro['nome']" value="<?php echo $filtro['nome']; ?>">
    </div>
  </div>
  <div class="form-group col-md-3">
        <label for="campo2">Fabricante:</label>
            <select class="form-control" name="filtro['fabricante']">
                <option onfocus="true">Selecione...</option>
                <?php if ($fabricantes) : ?>
                    <?php foreach ($fabricantes as $fabricante) : ?>
                        <option value="<?php echo $fabricante['id_fabfiltro']; ?>"><?php echo $fabricante['nome']; ?></option>
                    <?php endforeach; ?>
                <?php else : ?>
