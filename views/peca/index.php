...
<div class="container-fluid">
    <h2 class="h3 mb-0 text-gray-800">Peças Cadastradas</h2>
    ...
    <?php if ($pecas ) : ?>
        <?php foreach ($pecas as $peca) : ?>
            <tr>
                ...
                <td><?php echo "R$ ". $peca['valor']; ?></td>
                <?php translateTipo($peca['tipo']); ?>
                <td><?php echo $nameTipo; ?></td>
                <td><?php echo $peca['hrs_prod']; ?></td>
