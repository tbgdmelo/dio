        ...
        <?php foreach ($pecas as $peca) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="edit.php?id_peca=<?php echo $peca['id_peca']; ?>" class="btn btn-sm btn-warning">Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-peca" data-peca="<?php echo $peca['id_peca']; ?>"> Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else : ?>
...
<script src="<?php echo BASEURL; ?>front/js/modal_peca.js"></script>