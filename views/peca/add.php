...
<div class="container-fluid">
  <h2 class="h3 mb-0 text-gray-800">Nova Peça</h2>
  ...
  <form action="add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control" name="peca['nome']" autofocus="" placeholder="Nome">
      </div>
      <div class="form-group col-md-3">
        <label for="name">Valor:</label>
        <input type="text" class="form-control" id="currency" name="peca['valor']" size="15" maxlength="14" data-decimal="."/>
      </div>
      <div class="form-group col-md-3">
      ...
      <div class="form-group col-md-3">
        ...
        <input type="number" class="form-control" name="peca['hrs_prod']"/>
      </div>
    </div>
