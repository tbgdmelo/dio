...
<head>
    ...
    <title>Atualizar Cadastro Tipo de Peça</title>
</head>
...
<div id="content">
  ...
  <h2 class="h3 mb-0 text-gray-800">Atualizar Dados do Tipo de Peça</h2>
<form action="edit.php?id_tipo=<?php echo $tipopeca['id_tipo']; ?>" method="post" enctype="multipart/form-data">
  <!-- area de campos do form -->
  <hr />
  <div class="row">
    <div class="form-group col-md-3">
      <label for="name">Nome:</label>
      <input type="text" class="form-control" name="tipopeca['nome']" value="<?php echo $tipopeca['nome']; ?>">
    </div>
  </div>
